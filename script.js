...
function initMobileMenu() {
    ...
    if (mobileMenuButton) {
        mobileMenuButton.addEventListener('click', () => {
            ...
            showNotification('Mobile menu would open here. This is a demo version.', 'info');
        });
    }
}
...
function handlePartnershipForm(event) {
    ...
    showNotification('Thank you for your interest! We\'ll contact you soon about partnership opportunities.', 'success');
    form.reset();
}
